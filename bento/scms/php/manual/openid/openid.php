...
<head>
	...
	#openid INPUT.openid_login{
	   background: url(file:///C|/Users/jesse/Downloads/imgs/3rdparty/openid-login-bg.gif) no-repeat;
...
<form action="<?phpecho 'http://' . $_SERVER["HTTP_HOST"] . $_SERVER["PATH_INFO"]; ?>" method="post" onSubmit="this.login.disabled=true;">
