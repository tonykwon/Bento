...
var Autocompleter = new Class({
	...
	showChoices: function() {
		...
		if (this.fix) {
			...
			this.choices.setStyles({
				'left': pos.left,
				'top': pos.bottom,
				'width': 400 /*(width === true || width == 'inherit') ? pos.width : width*/,
				'padding': 0
			});
	...
	choiceSelect: function(choice) {
		...
		if( values != null && values.url != null && values.url != "" ){
				...
				document.location.href = values.url + "?" + values.value + "=" + choice.id + "&" + values.text + "=" + choice.get('text');
		...
		if( values != null && values["function"] != null && values["function"] != "" ){
				...
				// alert( values["function"] + ' ' + choice.id + ' ' + values.text + ' ' + choice.get('text') );

				eval( values["function"] + "('" + choice.id + "','" + choice.get('text') + "');" );
			
		// if
		}
		
		if( $( bento.form.loading ) ){
		
			$( bento.form.loading ).setStyle('display','block');
...
Autocompleter.Request.JSON = new Class({
	...
	initialize: function(el, options) {
		...
		this.request = new Request.JSON($merge({
			'url': bento.form.url + "?" + bento.form.querystring + "&" + bento.form.autocomplete,
			'link': 'cancel'
